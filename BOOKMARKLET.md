...
Loads a specific tagged version. Replace `v1.2.0` with the desired tag:

```
javascript:(()=>{var s=document.createElement('script');s.src='https://cdn.jsdelivr.net/gh/mnlynam/pike13-batch@v1.2.0/dist/pike13-batch.js';document.body.appendChild(s);})();
```
