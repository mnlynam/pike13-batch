...
The `?+Date.now()` defeats jsdelivr's edge cache so iteration is live. For stable use, pin a version: `@v1.0.0`.
...
- Versioned: `cdn.jsdelivr.net/gh/mnlynam/pike13-batch@v1.0.0/dist/pike13-batch.js`
